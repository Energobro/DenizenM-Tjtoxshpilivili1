...
public class ItemHelperImpl extends ItemHelper {
    ...
    public static final MethodHandle CRAFT_ITEM_STACK_AS_BUKKIT_COPY = ReflectionHelper.getMethodHandle(CraftItemStack.class, "asBukkitCopy", net.minecraft.world.item.ItemInstance.class);
